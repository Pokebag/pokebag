	...
	return (
		<BaseLayout
			...
			<section className="box content section">
				<p>We use cookies to help improve your experience of <Link href="/"><a>https://pokeb.ag</a></Link>. This cookie policy is part of Pokébag's privacy policy, and covers the use of cookies between your device and our site. We also provide basic information on third-party services we may use, who may also use cookies as part of their service, though they are not covered by our policy.</p>

				<p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <Link href="/"><a>https://pokeb.ag</a></Link>, with the understanding that we may be unable to provide you with some of your desired content and services.</p>
			</section>
