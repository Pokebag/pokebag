	...
	return (
		<BaseLayout
			...
			<section className="box content section">
				<p><em>This policy is effective as of September 10, 2021.</em></p>

				<p>Your privacy is important to us. It is Pokébag's policy to respect your privacy regarding any information we may collect from you across our website, <Link href="/"><a>https://pokeb.ag</a></Link>, and other sites we own and operate.</p>
			</section>
			...
			<section className="box content section">
				...
				<ul>
					...
					<li>to enable you to access and use our website, associated applications and associated social media platforms; and</li>
			...
			<section className="box content section">
				...
				<ul>
					...
					<li>Vercel (<ExternalLink href="https://vercel.com/legal/dpa">Data Processing Agreement</ExternalLink>)</li>
				</ul>
			...
			<section className="box content section">
				...
				<p>
					<strong>Pokébag Data Controller &amp; Data Protection Officer</strong>
					<br />
					Charles Peebles<br />
